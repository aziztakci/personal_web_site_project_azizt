          ...
          >
            ...
            <div className="flex gap-1.5">
              ...
              {e.tags.map((tag, index) => (
                <span
                  key={`project-tags-${index}`}
                  className={` text-lg xl:text-sm border rounded-md px-4.5 py-1.75 leading-none  ${
                    theme === "light"
                      ? " text-deep-purple"
            ...
            <div className="flex justify-between">
              ...
              {e.links.map((link, index) => (
                <a
                  key={`project-links-${index}`}
                  href="https://www.google.com" 
                  target="_blank" 
                  rel="noopener noreferrer" // gizlilik için gerekli, güvenlik önlemi...
                  className={`text-xl xl:text-base underline cursor-pointer transition-colors duration-300 ${
                    theme === "light" ? "text-deep-purple" : "text-deep-gray"
                  }`}
                >
                  {link}
                </a>
