      ...
      <div className="flex flex-col order-2 xl:order-1 gap-10">
        ...
        <div className="flex flex-col md:flex-row item-center justify-between xl:justify-start gap-3">
          ...
          {heroData.socials.map((e, index) => (
            <button
              key={index}
              className={`flex item-center justify-center md:justify-start border pr-5 pl-2.5 py-3 rounded-md font-semibold text-lg cursor-pointer gap-2.5 transition-colors ${
                  theme === "light"
